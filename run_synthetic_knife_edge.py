...
for distribution_name in distribution_list:
    ...
    file_name = f'./data/{distribution_name}_knife_edge.csv'
    ...
    if distribution_name == 'uniform':
        qbar = 100 # Update upper bound on M for this, to ensure that \qcrit = \qopt
                ...
                for N in N_list:
                    ...
                    for _ in range(num_iters):
                        ...
                        for algo_name, algo_func in algorithm_list: # Loops over each algorithm and evaluates it
                            ...
                            helper.add_to_data(data, algo_name, 'estimate', sol, **common_params)
